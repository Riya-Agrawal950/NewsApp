    ...
    return (
        <>
            <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                <div className="card">
                    <img src={props.pic ? props.pic : "/images/notavl.png"} height="150px" width="100%" className="card-img-top" alt="..." />
                    <div className="card-body">
                        ...
                        <hr />
                        <p className="card-text">{props.description && props.description.slice(0, 200) + "..."}</p>
